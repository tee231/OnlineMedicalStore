        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Stores_storesId",
                        column: x => x.storesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreOwnerDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StoreOwnerDetails_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_storesId",
                table: "AspNetUsers",
                column: "storesId");

            migrationBuilder.CreateIndex(
                name: "IX_Drugs_StoresId",
                table: "Drugs",
                column: "StoresId");

            migrationBuilder.CreateIndex(
                name: "IX_StoreOwnerDetails_StoreId",
                table: "StoreOwnerDetails",
                column: "StoreId");
        }
